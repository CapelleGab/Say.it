...
export const MovieCard = ({ movieInfo }: { movieInfo: MovieDetails }) => {
  ...
  return (
    <>
      {isVisible ? (
        <div className="fixed right-4 md:right-6 top-[50%] translate-y-[-50%] w-72 sm:w-80 md:w-96 bg-background/90 backdrop-blur-sm border border-border/50 rounded-xl shadow-lg p-4 z-10 max-h-[90vh] overflow-y-auto">
